...
namespace SeleniumTest
{
    ...
    public class SeleniumTests : Configuration
    {
        ...
        /// </summary>
        [TestMethod]
        [DeploymentItem("PurchasePhoneTest.xml")]
        ...
        /// </summary>
        [TestMethod]
        [DeploymentItem("UpdateAccountTest.xml")]
        ...
        /// </summary>
        [TestMethod]
        [DeploymentItem("EmptyCartTest.xml")]
        ...
        public void ValidateEmptyCartMessageAfterItemRemoved()
        {
            ...
            string productDisplayName = Convert.ToString(context.DataRow["productDisplayName"]);
            string productTextName = Convert.ToString(context.DataRow["productTextName"]);
            string expectedCartMsg = Convert.ToString(context.DataRow["emptyCartMsg"]);
            ...
            Assert.IsTrue(Checkout.IsEmptyCartMessageShown(expectedCartMsg));
        }
